...
| **Ecosystem Fund & Community Incentives** | 30% | 300,000,000 | Strategic releases for grants, development programs focused on advanced models, and user adoption |
...
```mermaid
pie title Token Supply Allocation
    "Ecosystem Fund & Community" : 30
    "Node Runner Rewards Pool (Compute)" : 35
    "Team & Advisors" : 15
...
#### **Current Round (5%)**
The ongoing investment round at $240M valuation will follow similar vesting terms to ensure alignment with long-term network success in serving powerful multimodal models.
