...
description: A step‑by‑step walkthrough of what it feels like to run AI on the Dria Network or inside your own data‑center with the same license, the same compiler, and the same credit balance.
---
...
### 3. Running On‑Prem with Dria the License
